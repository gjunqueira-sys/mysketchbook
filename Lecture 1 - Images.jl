...
# ╔═╡ 4b97e7f0-0593-11eb-19f8-094c3e8e3999
using Colors
...
# ╔═╡ 34385a70-0590-11eb-2f30-2f744f845c3c
img  = load(philip_file)

# ╔═╡ 341ae760-0590-11eb-2744-971e954ea84c
pixel1 = img[1, 1]

# ╔═╡ 4b1f0e70-0593-11eb-26a1-8f1fb98f1745
md"# Reading RGB values from pixels"

# ╔═╡ 2f375960-0593-11eb-21fb-6b69e2a254cd
[pixel1.r, pixel1.g, pixel1.b] #reading channel red, green , blue from Pizel

# ╔═╡ 2f152b60-0593-11eb-06a8-dfcba57391ae
RGB(1.0, 0.0, 0.0) # red

# ╔═╡ 2ef2fd62-0593-11eb-309d-3b04f3d68e16
RGB(0.0, 1.0, 0.0) # green

# ╔═╡ e0ee0a00-0593-11eb-1984-131c382afb59
RGB(0.0, 0.0, 1.0) # blue

# ╔═╡ e0cd1480-0593-11eb-21f3-3bdf1853eeb5


# ╔═╡ 33fd9b60-0590-11eb-1976-2dea43e8fb7d
typeof(img[1:1, 1:1])

# ╔═╡ 33e07670-0590-11eb-3cea-a32fb43ea36b
typeof(img[1, 1])

# ╔═╡ 33c462f0-0590-11eb-327b-8979b4d1c825
imgg = rand(4, 3)

# ╔═╡ 33a5de70-0590-11eb-06b1-a5105d4776f9
begin
	Gray(0.0) # black
	Gray(1.0) # white
	RGB(1.0, 0.0, 0.0) # red
...
# ╔═╡ 333457f0-0590-11eb-2120-6d1409534086
Gray.(imgg)

# ╔═╡ 58954b90-0594-11eb-3552-d961740b3303
Gray.(philip)

# ╔═╡ 3fe34610-0594-11eb-2fd7-ab218414509a
philip

# ╔═╡ 3fc13f20-0594-11eb-2912-439f25272185
extract_red(philip[1,1])

	
	

# ╔═╡ 32f79d10-0590-11eb-33aa-f10618de08e0
